...
This step is only required in Anytrust mode. For an explanation of AnyTrust mode and the role of the Data Availability Committee (DAC), see [AnyTrust Mode](/docs/run-a-node/data-availability#anytrust-mode).
