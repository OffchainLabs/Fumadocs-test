---
title: 'Oracles'
description: 'Overview of blockchain oracles on Arbitrum — external data providers that supply offchain data to smart contracts. Learn how oracles work, their trust models, and available providers on Arbitrum.'
sidebar_label: Oracles
user_story: 'As a developer, I want to understand how oracles work on Arbitrum so I can integrate real-world data into my smart contracts.'
content_type: 'concept'
author: gblanchemain
sme: gblanchemain
---

<VanillaAdmonition type="note" title="This is a conceptual overview of oracles. For more detailed information on how to use oracles in your applications, check out our [third-party oracles documentation](/docs/oracles).">
...
You can learn more about oracles in our [third-party oracles documentation](/docs/oracles).
