...
You can find more info about **WETH** gateways in our ["other gateways flavors" documentation](/docs/how-arbitrum-works/deep-dives/token-bridging#other-flavors-of-gateways).
