...
<VanillaAdmonition type="note" title="This list is not exhaustive, and will be continuously updated as the Arbitrum ecosystem evolves.">
...
You can easily launch an Arbitrum chain with a canonical token bridge, which allows transfers to and from the chain via <Term id="arbitrum-one">Arbitrum One</Term>, <Term id="arbitrum-nova">Nova</Term>, or the parent chain to which your Arbitrum chain settles transactions.
