...
The ArbOS 60 governance temperature check has already passed successfully. Upstream governance for ArbOS 60 follows the standard process, including Snapshot temperature checks and an onchain vote prior to activation on Arbitrum One and Nova.
