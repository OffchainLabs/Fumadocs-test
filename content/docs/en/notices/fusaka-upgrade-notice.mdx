...
<VanillaAdmonition type="danger" title="🛑 IMPORTANT 🛑">
...
<VanillaAdmonition type="warning" title="Exceptions">
...
To read more about Fusaka PeerDAS changes and why Layer 2 network operators must connect to an Ethereum beacon chain node with historical blob data, see the [historical blobs docs](/docs/run-a-node/beacon-nodes-historical-blobs).
