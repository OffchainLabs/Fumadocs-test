...
Deploying an **ERC-20** token on <Term id="arbitrum-one">Arbitrum One</Term> is fully permissionless and uses the same tooling and workflows as Ethereum.

You can deploy directly to Arbitrum One using Foundry, and optionally configure [bridging](/docs/arbitrum-essentials/bridging/overview), liquidity, and supporting <Term id="smart-contract">smart contract</Term> infrastructure as part of your token creation.
