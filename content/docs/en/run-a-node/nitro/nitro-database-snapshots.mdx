...
<VanillaAdmonition type="info" title="PathDB snapshot auto-download with `--init.latest` is not yet supported.">
:::
...
:::tip For most users, automatic download is recommended
