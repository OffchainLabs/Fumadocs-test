...
| -------------------------------------------------------------------------- | ------------------------------------------ | -------------------- |
| [Nitro 3.11.x](https://github.com/OffchainLabs/nitro/releases/tag/v3.11.1) | 30 calendar days after 3.11.x is released. | Docker               |
| [Nitro 3.10.2](https://github.com/OffchainLabs/nitro/releases/tag/v3.11.0) | July 22, 2026                              | Docker               |
...
<VanillaAdmonition type="warning" title="In exceptional cases, such as for stability or security fixes, we may cut a new minor Nitro release within 30 days of a previous minor release and immediately drop support for that release. When this happens, we may ask teams to upgrade sooner to the new release for security and stability reasons.">
...
<ImageZoom src="/img/nitro-support-policy.png" className="img-600px" alt="Nitro support windows">
  Nitro support windows
</ImageZoom>

The currently supported versions can be found on the [Nitro start here](/docs/run-a-node/start-here#recommended-nitro-version) page.
...
- Follow our [X handle](https://x.com/ArbitrumDevs) for all things geared towards developers building with and on Arbitrum.
