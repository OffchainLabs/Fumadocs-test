...
<VanillaAdmonition type="warning" title="On Nitro before v3.10.0, also set `--execution.caching.state-history=0`">
...
For cache sizing and memory tuning that applies to archive nodes generally, see [Nitro memory management](/docs/run-a-node/nitro/nitro-memory-management.mdx).
