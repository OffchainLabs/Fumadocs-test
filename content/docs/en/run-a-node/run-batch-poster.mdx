...
- If your version is below 20, upgrade by following the [ArbOS upgrade guide](/docs/launch-arbitrum-chain/operate/arbos-upgrade).
...
If your version is below ArbOS 20, upgrade by following the [ArbOS upgrade guide](/docs/launch-arbitrum-chain/operate/arbos-upgrade).
