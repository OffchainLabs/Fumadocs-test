...
<VanillaAdmonition type="note" title="This documentation is for production sequencer deployments. If you want to set up a sequencer for testing or on a testnet, please refer to [How to run a testnet sequencer node](/docs/run-a-node/sequencer/run-sequencer-node).">
...
<ImageZoom src="/img/ha-sequencer-sendto-active.png" alt="send to active enable" className="img-900px" />
...
<ImageZoom src="/img/ha-sequencer-send-to-nonactive.png" alt="send to active disable" className="img-900px" />
...
You can check [run a feed relay](/docs/run-a-node/run-feed-relay) to see how to set up a relay node.
...
- Follow detailed instructions at: [Running a Sequencer Coordinator Manager](https://docs.arbitrum.io/docs/run-a-node/how-tos/running-a-sequencer-coordinator-manager)
...
- [How to Run a Fullnode](https://docs.arbitrum.io/docs/run-a-node/how-tos/running-a-node)
- [Running a Sequencer Coordinator Manager](https://docs.arbitrum.io/docs/run-a-node/how-tos/running-a-sequencer-coordinator-manager)
