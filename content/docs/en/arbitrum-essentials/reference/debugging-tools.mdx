...
description: 'Overview of debugging tools for Arbitrum dApp development, including Tenderly and other platforms for transaction simulation, tracing, and smart contract debugging on Arbitrum chains.'
user_story: 'As a developer, I want to find debugging tools for Arbitrum so I can diagnose and fix issues in my smart contracts and transactions.'
...
Although Tenderly provides great debugging options, there are certain limitations when debugging [parent-to-child chain messages](/docs/how-arbitrum-works/deep-dives/l1-to-l2-messaging) (also known as [Retryable Tickets](/docs/arbitrum-essentials/bridging/cross-chain-messaging#ethereum-to-arbitrum-messaging)), due to the utilization of custom Geth errors. For further information on this constraint, please refer to the following [resource](/docs/for-devs/troubleshooting-building#i-tried-to-create-a-retryable-ticket-but-the-transaction-reverted-on-l1-how-can-i-debug-the-issue).
