---
title: 'Arbitrum chain licensing'
description: 'Learn about the Arbitrum chain license and AEP.'
sidebar_label: 'Arbitrum chain licensing'
user_story: As a prospective Arbitrum chain owner, I need to understand the Arbitrum chain license.
...
- L3s that settle to parent chains other than Arbitrum One and Nova must contribute [net chain revenue](/docs/launch-arbitrum-chain/configure-your-chain/common/aep-fees/calculate-aep-fees.mdx#calculating-aep-fees), where 8% flows to the DAO and 2% to the developer guild.
