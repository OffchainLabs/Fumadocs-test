...
Before you read this doc, please ensure you have already walked through [run a validator](/docs/run-arbitrum-node/more-types/run-validator-node.mdx) docs to understand the basics of a validator node.
