...
| :--------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Deployed chain**     | Complete [Deploy your first rollup](/docs/launch-arbitrum-chain/deploy-an-arbitrum-chain/deploy-your-first-rollup.mdx), Steps 1–4 (deploy, generate config, fund batch poster and validator), **do not complete Step 5** |
