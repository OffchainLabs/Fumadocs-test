...
Once you have deployed your Arbitrum chain and have a node running, you can deploy a token bridge for your chain. See the [Overview](/docs/launch-arbitrum-chain/arbitrum-chain-sdk-introduction.mdx) for an introduction to creating and configuring an Arbitrum chain.

Before reading this guide, we recommend:

- Becoming familiar with the general process of creating new chains explained in [How to deploy an Arbitrum chain](/docs/launch-arbitrum-chain/deploy-an-arbitrum-chain/deploying-an-arbitrum-chain.mdx)
