---
title: 'Configure smart contract size limit'
description: 'Learn how to configure the smart contract size limits on your Arbitrum chain'
content_type: 'how-to'
...
<VanillaAdmonition type="warning" title="- This change is immutable after deployment—plan carefully.">
...
- This extends Step 1 in preparation of the full node config (e.g., for running a <a data-quicklook-from="sequencer">sequencer</a> or validator node). Place this in a file like `deployOrbitChain.ts`. It assumes you’re deploying to a parent chain, such as Sepolia (testnet).
