...
To read more about Arbitrum BoLD, please refer to the [Gentle Introduction for BoLD](/docs/how-arbitrum-works/bold/gentle-introduction).
...
This how-to provides step-by-step instructions for <Term id="layer-2-l2">L2</Term> Arbitrum chain operators who want to enable BoLD on their chain. Familiarity with Nitro, [BoLD](/docs/how-arbitrum-works/bold/gentle-introduction), and [chain ownership](/docs/launch-arbitrum-chain/operate/ownership-access-control) is expected.
