...
To configure [Sequencer](/docs/how-arbitrum-works/deep-dives/sequencer.mdx) timing parameters when launching an <Term id="arbitrum-chain">Arbitrum chain</Term>, you'll primarily adjust settings in two places:
...
For more on force inclusion and the Delayed Inbox, see the [Sequencer deep dive](/docs/how-arbitrum-works/deep-dives/sequencer.mdx).
