...
As a <a data-quicklook-from="raas">RaaS</a> or <a data-quicklook-from="chain-owner">Chain Owner</a>, if you require internal daily reporting on fees, we have an [RPC script you can leverage for reporting purposes](https://github.com/yahgwai/aep-fee-tracker/).
...
There are two main <a data-quicklook-from="l1">L1</a> fee collector addresses:

1. **L1 Base Fee**: Refunds <a data-quicklook-from="batch-poster">Batch Poster</a> for <a data-quicklook-from="parent-chain">parent chain</a> posting costs
2. **L1 Surplus**: Collects profit on <a data-quicklook-from="batch">Batch</a> posting fees
...
1. Users send transactions on the <a data-quicklook-from="child-chain">child chain</a>
...
1. <a data-quicklook-from="arbos">ArbOS</a> consumes batch posting reports
...
<VanillaAdmonition type="note" title="Method 1 and Method 2 should be roughly equivalent over the long term.">
...
<VanillaAdmonition type="warning" title="If both criteria are met → indicates misconfiguration">
