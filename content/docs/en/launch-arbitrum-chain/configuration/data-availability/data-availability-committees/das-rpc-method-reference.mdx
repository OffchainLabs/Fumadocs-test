...
| --------- | -------------- | ------------------------------------------------------ | ------------------------------------------------------------------- |
| RPC       | `:9876`        | <a data-quicklook-from="batch-poster">Batch Poster</a> | Store <a data-quicklook-from="batch">batch</a> data, obtain DACerts |
...
- The DAS server assembles the chunks, stores the complete payload, and returns a signed DACert component (the server's <a data-quicklook-from="bls-signature">BLS Signature</a> over the data hash)
...
| `data-availability.parent-chain-node-url`   | —                        | <a data-quicklook-from="parent-chain">Parent chain</a> RPC URL |
