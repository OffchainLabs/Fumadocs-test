...
<div className="dynamic-content-tabs">
  <Tabs items={["AWS S3 bucket","Local files","(Experimental) Google Cloud Storage","(Deprecated) Local Badger database"]}>
    <Tab value="AWS S3 bucket">
      <include>./partials/parameters/_s3-parameters.mdx</include>
    </Tab>
    <Tab value="Local files">
      <include>./partials/parameters/_local-files-parameters.mdx</include>
    </Tab>
    <Tab value="(Experimental) Google Cloud Storage">
      <include>./partials/parameters/_gcs-parameters.mdx</include>
    </Tab>
    <Tab value="(Deprecated) Local Badger database">
      <include>./partials/parameters/_local-badger-db-parameters.mdx</include>
    </Tab>
  </Tabs>
</div>
...
<include>./partials/_das-optional-parameters.mdx</include>

## Metrics

<include>./partials/_das-metrics.mdx</include>
