...
<a data-quicklook-from="sequencer">Sequencer</a> runtime, batch poster, bonder/validators, DAC signer set for AnyTrust, RPC/explorer domains, alerting/monitoring credentials. Your RaaS may have other requirements.
...
<a data-quicklook-from="chain-owner">Chain Owner</a>. Typical partners include oracles, indexers, bridges, wallets, analytics, and custody, among others.
...
2. Ownership transfer of any onchain contracts.
