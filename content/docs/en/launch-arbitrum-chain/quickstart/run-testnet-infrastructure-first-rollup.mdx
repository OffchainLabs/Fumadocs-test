...
<VanillaAdmonition type="tip" title="Run all steps in the same terminal">
...
| :--------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Deployed chain**     | Complete [Deploy your first rollup](/docs/launch-arbitrum-chain/quickstart/deploy-your-first-rollup), Steps 1–4 (deploy, generate config, fund batch poster and validator), **do not complete Step 5** |
...
<Accordions>
<Accordion title="node-config.json">
...
<Accordions>
<Accordion title="Deploy sequencers:">
...
<Accordions>
<Accordion title="Create sequencer-extra-env.yaml">
...
<VanillaAdmonition type="warning" title="Set sequencer priority after deployment">
...
<Accordions>
<Accordion title="Run the following commands:">
...
<Accordions>
<Accordion title="Deploy the batch poster:">
...
<VanillaAdmonition type="warning" title="Do not add batch poster to sequencer priority">
...
<Accordions>
<Accordion title="Deploy the validator:">
...
<VanillaAdmonition type="warning" title="Required for sequencer activation">
...
<VanillaAdmonition type="tip" title="Add all sequencers to priority list">
...
<VanillaAdmonition type="warning" title="Do **not** add the batch poster to the priority list. The batch poster should never become the active sequencer.">
...
For running production mainnet, consider a RaaS provider. For a [list of RaaSes is on the Third-party providers page](/docs/launch-arbitrum-chain/third-party-integrations/third-party-providers.mdx#rollup-as-a-service-raas-providers).
