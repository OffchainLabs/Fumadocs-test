...
<include>../../partials/_hardware-requirements.mdx</include>

#### Validator node

Monitors assertions and challenges fraud. Runs on top of a full node with bonder software enabled. BoLD upgrade makes it more efficient, assuming one honest party.
...
| **Bandwidth** | 100 Mbps                    | 500 Mbps+            | For monitoring and bonding (e.g., 3,600 **ETH** equivalent bond).             |
