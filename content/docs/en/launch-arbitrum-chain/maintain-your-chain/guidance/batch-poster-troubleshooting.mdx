...
This guide covers common operational issues that batch poster operators encounter, with guidance on diagnosing root causes and resolving them. For initial setup, see [Run a batch poster](/docs/launch-arbitrum-chain/arbitrum-node-runners/run-batch-poster.mdx). For fee-related tuning, see [Batch poster fee tuning](/docs/launch-arbitrum-chain/configure-your-chain/common/validation-and-security/batch-poster-fee-tuning.mdx).
...
The [Monitoring tools and considerations](/docs/launch-arbitrum-chain/maintain-your-chain/monitoring-tools-and-considerations.mdx) guide recommends monitoring the batch poster balance. In practice, this means:
...
- **Check the sequencer's transaction backlog size**: As noted in the [Monitoring tools and considerations](/docs/launch-arbitrum-chain/maintain-your-chain/monitoring-tools-and-considerations.mdx) guide, a large and growing backlog can be a sign of network health issues.
...
2. **Check the parent chain gas prices**: If prices exceed your fee cap, either wait for prices to drop or increase `--node.batch-poster.data-poster.target-price-gwei` (see [Batch poster fee tuning](/docs/launch-arbitrum-chain/configure-your-chain/common/validation-and-security/batch-poster-fee-tuning.mdx)).
