...
The [`ArbOwner` precompile reference](/docs/build-decentralized-apps/precompiles/reference.mdx#arbowner) can be found on the [Precompiles reference page](/docs/build-decentralized-apps/precompiles/reference.mdx).
...
<VanillaAdmonition type="note" title="The DAO Governed chains' Upgrade Executor contracts don't have the `.executeCall` method; only the `.execute` method">
