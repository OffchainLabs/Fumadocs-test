...
The [`ArbOwner` precompile reference](/docs/arbitrum-essentials/precompiles/reference.mdx#arbowner) can be found on the [Precompiles reference page](/docs/arbitrum-essentials/precompiles/reference).
