...
Before reading this guide, we recommend that you're familiar with the general process for creating new chains explained in the introduction and the first section of [How to deploy an Arbitrum chain](/docs/launch-arbitrum-chain/deploy-an-arbitrum-chain/deploying-an-arbitrum-chain.mdx).
...
You can find information about what these parameters configure in [How to configure a DAC](/docs/launch-arbitrum-chain/configure-your-chain/common/data-availability/data-availability-committees/configure-dac.mdx).
