...
3. **Build custom node**: Create Docker images (dev and production) with changes; extract and set the new <a data-quicklook-from="wasm-module-root">WASM module root</a> on the parent chain via contract calls.
