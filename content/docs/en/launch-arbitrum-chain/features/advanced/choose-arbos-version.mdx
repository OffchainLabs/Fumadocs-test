...
3. **Build custom node**: Create Docker images, extract the new <a data-quicklook-from="wasm-module-root">WASM module root</a>, and update it on the parent chain via `setWasmModuleRoot` on the rollup contract.
...
This reflects Arbitrum's modularity but demands rigorous testing. Refer to the docs or your <a data-quicklook-from="raas">RaaS</a>; a [list of RaaSes is on the Third-party providers page](/docs/launch-arbitrum-chain/third-party-integrations/third-party-providers.mdx#rollup-as-a-service-raas-providers).
