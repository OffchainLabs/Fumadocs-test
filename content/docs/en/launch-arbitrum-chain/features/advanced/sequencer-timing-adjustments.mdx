...
For information on how to configure the Sequencer timing, refer to the [Sequencer Timing Adjustments configuration](/docs/launch-arbitrum-chain/configure-your-chain/advanced/config-sequencer-timing-adjustments.mdx) page.
