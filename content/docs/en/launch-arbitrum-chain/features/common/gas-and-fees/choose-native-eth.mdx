...
<include>../../partials/_native-eth-pc.mdx</include>
...
This default choice emphasizes reliability and Ethereum-native operations within Arbitrum's modular framework. For deployment details, consult the official docs, or your <a data-quicklook-from="raas">RaaS</a>; a [list of RaaSes is on the Third-party providers page](/docs/launch-arbitrum-chain/third-party-integrations/third-party-providers.mdx#rollup-as-a-service-raas-providers).
