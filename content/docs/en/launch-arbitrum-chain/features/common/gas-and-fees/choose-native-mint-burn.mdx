...
[ArbOS 51 Dia](/docs/run-arbitrum-node/arbos-releases/arbos51) introduces the ability for native-interop tokens to be the gas token of an Arbitrum chain. This feature allows a chain owner (`ArbOwner`) to manage:
...
<ImageZoom src="/img/mint-burn-gas-token-hld.png" alt="Bridge provider mint and burn" className="img-600px" />
...
<ImageZoom src="/img/bridge-provider-mint-burn-diagram.png" alt="Bridge provider mint and burn" caption="A third-party messaging layer triggers its Adapter to unlock to a specific address. The Adapter mints new tokens and distributes them to the user." className="img-600px" />
...
To learn how to configure this feature for your chain refer to the [Configure a native mint/burn gas token](/docs/launch-arbitrum-chain/configure-your-chain/common/gas/configure-native-mint-burn-gas-token.mdx) page.
