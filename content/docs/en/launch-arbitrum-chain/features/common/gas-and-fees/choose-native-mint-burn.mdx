...
To learn how to configure this feature for your chain refer to the [Configure a native mint/burn gas token](/docs/launch-arbitrum-chain/configuration/costs/configure-native-mint-burn-gas-token) page.
