...
This is an abbreviated set of instructions on how to configure AEP fees. For a complete set of instructions refer to the [AEP fee router introduction](/docs/launch-arbitrum-chain/configure-your-chain/common/aep-fees/aep-fee-router-introduction.mdx).

Additional resources:

- [Setup AEP fee router](/docs/launch-arbitrum-chain/configure-your-chain/common/aep-fees/set-up-aep-fee-router.mdx)
- [Calculate AEP fees](/docs/launch-arbitrum-chain/configure-your-chain/common/aep-fees/calculate-aep-fees.mdx)
- [Reporting on AEP fees](/docs/launch-arbitrum-chain/configure-your-chain/common/aep-fees/reporting-on-fees.mdx)
...
This setup reflects Arbitrum's collaborative model, ensuring custom chains contribute back while benefiting from the ecosystem. For implementation, refer to the docs or your <a data-quicklook-from="raas">RaaS</a>; a [list of RaaSes is on the Third-party providers page](/docs/launch-arbitrum-chain/third-party-integrations/third-party-providers.mdx#rollup-as-a-service-raas-providers).
