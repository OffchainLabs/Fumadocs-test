...
<VanillaAdmonition type="info" title="Use the Arbitrum Chain SDK">

You can use these contracts to create Arbitrum chains. However, it is strongly recommended to go through the [Chain SDK](/docs/launch-arbitrum-chain/overview/arbitrum-chain-sdk-introduction) to interact with them. Doing so prevents misconfiguring parameters and using appropriate defaults for most of them.
...
<VanillaAdmonition type="warning" title="The use of non-canonical factory contracts is unsupported">
