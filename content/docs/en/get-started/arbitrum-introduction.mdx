...
To learn more about validators and the different types of validators, refer to the [Run a validator node](/docs/run-arbitrum-node/more-types/run-validator-node) page.
...
If you want to know more about the differences between Arbitrum and Ethereum, refer to the [Comparison overview](/docs/build-decentralized-apps/arbitrum-vs-ethereum/comparison-overview).
...
You can also create your own Arbitrum chain with custom gas tokens. For example, you could create a chain that uses USDC for gas. Arbitrum chains are endlessly customizable beyond the gas token. You can learn more about [Arbitrum chains](/docs/launch-arbitrum-chain/a-gentle-introduction).
...
<ImageZoom src="/img/arbitrum-chains-diagram.jpeg" alt="Arbitrum chains diagram" className="img-600px" />
...
If you want to create your own chain, check out the [Arbitrum chain introduction](/docs/launch-arbitrum-chain/a-gentle-introduction).
